-- Idempotent PostgREST schema refresh for migration_status (after SQL Editor runs without NOTIFY).
-- Safe to re-run: CREATE TABLE IF NOT EXISTS + policy guard + NOTIFY only.
