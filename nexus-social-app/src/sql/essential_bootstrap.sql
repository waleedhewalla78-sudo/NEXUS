-- Essential Nexus Social bootstrap (safe for Supabase SQL Editor).
-- Run this ONCE when you see: "Could not find the table 'public.workspace_members'"
...
-- Patch columns that may be missing on existing databases
